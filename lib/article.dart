...
class Article {
    ...
    factory Article.fromJson(Map<String, dynamic> json) => Article(
        ...
        externalLinks: List<ExternalLink>.from(json["externalLinks"].map((x) => ExternalLink.fromJson(x))),
        images: List<ExternalLink>.from(json["images"].map((x) => ExternalLink.fromJson(x))),
    ...
    Map<String, dynamic> toJson() => {
        ...
        "author": author,
        "content": content,
        "externalLinks": List<dynamic>.from(externalLinks.map((x) => x.toJson())),
...
class ExternalLink {
    ...
    factory ExternalLink.fromRawJson(String str) => ExternalLink.fromJson(json.decode(str));
